...
def main():
    ...
    auto_button = ttk.Button(main_frame, text="Auto-Driving")
    auto_button.grid(row=0, column=1)

    auto_button['command'] = lambda: auto_driving(mqtt_client)
...
def auto_driving(mqtt_client):
    print("auto driving")
    mqtt_client.send_message("auto_driving")
