...
def main():
    # Setup an mqtt_client.  Notice that since you don't need to receive any messages you do NOT need to have
    ...
    # Implement the callbacks for the drive buttons. Set both the click and shortcut key callbacks.
